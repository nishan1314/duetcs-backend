...
CREATE TABLE IF NOT EXISTS audit_logs (
    ...
    actor_type ENUM('SUPER_ADMIN', 'ADMIN', 'SYSTEM') NOT NULL,
    actor_name VARCHAR(100) NOT NULL,
    action ENUM('CREATE', 'UPDATE', 'DELETE', 'PUBLISH', 'UNPUBLISH', 'LOGIN', 'LOGOUT', 'ACTIVATE', 'DEACTIVATE', 'PROMOTE', 'DEMOTE') NOT NULL,
    entity_type VARCHAR(50) NOT NULL COMMENT 'e.g., user, admin, executive, post, event, settings',
    entity_id INT NULL,
