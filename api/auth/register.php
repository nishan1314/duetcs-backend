...
// Validate DUET student email format
$expectedEmail = strtolower($studentId . '@student.duet.ac.bd');
if (strtolower($email) !== $expectedEmail) {
    sendResponse(400, false, "Email must be exactly your student ID in the format: {$studentId}@student.duet.ac.bd");
}
